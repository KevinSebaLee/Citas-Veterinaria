...
const CrearCita = ({ crearCita }) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="nombre" className="u-full-width" placeholder="Nombre Mascota" value={form.nombre} onChange={handleChange} />

            <label>Nombre Dueño</label>
            <input type="text" name="dueño" className="u-full-width" placeholder="Nombre dueño de la mascota" value={form.dueño} onChange={handleChange} />
